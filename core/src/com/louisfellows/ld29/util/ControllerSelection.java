...
public enum ControllerSelection {
    KEYBOARD_A("Keyboard A"), KEYBOARD_B("Keyboard B"), CONTROLLER_1("Controller 1"), CONTROLLER_2("Controller 2"), CONTROLLER_3("Controller 3"), CONTROLLER_4(
            "Controller 4"), AI("Computer"), NONE("None");
